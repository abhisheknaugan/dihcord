...
void AudioEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->encodedFrameReady((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 1: _t->audioError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->onCaptureDataReady(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AudioEngine::*)(const QByteArray & )>(_a, &AudioEngine::encodedFrameReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioEngine::*)(const QString & )>(_a, &AudioEngine::audioError, 1))
            return;
    }
}
...
// SIGNAL 0
void AudioEngine::encodedFrameReady(const QByteArray & _t1)
{
